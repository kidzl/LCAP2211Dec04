/**
 * 
 * @After(event = { "READ" }, entity = "LCAP2211ECCCICDService.SrvBooks")
...
module.exports = async function(context) {
    // Your code here
    const SrvBooks = Array.isArray(context.results) ? context.results : [context.results];
    SrvBooks.forEach(Books => {
          if (Books.price > 50) {
            Books.criticality = 1;
          } else {
            Books.criticality = 2;
